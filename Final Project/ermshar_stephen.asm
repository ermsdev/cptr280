...
.text
    ...
    read_inst:
        ...
        j end # end protection
        nop


    check_end:
        # if $v0 = 10 AND $s1 = 0x0000000c # (syscall)
        #   print the instruction and jumpt to end
        # else jr
        ori     $t9,    0xC         # using t9 as an immediate register (filling it with syscall instruction)
        bne     $s1,    $t9,    check_end_exit
        
    check_end_and:
        li      $t9,    10          # using $t9 as an immediate register
        bne		$v0, $t9, check_end_exit
    ...
    print_opc:
        ...
        # shifts current instruction, finds it's matching opc_txt, prints it
